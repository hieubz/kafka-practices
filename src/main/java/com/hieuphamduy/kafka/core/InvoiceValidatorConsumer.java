...
import com.hieuphamduy.kafka.config.JsonDeserializer;
...
@Slf4j
public class InvoiceValidatorConsumer {
  ...
  public static void main(String[] args) {
    ...
    consumerProps.put(ConsumerConfig.GROUP_ID_CONFIG, "invoice-validator-group");
    ...
    // consume messages and produce messages by checking valid field
    while (true) {
